...
| bestand | wat |
|---|---|
| `rekensterren-promo.mp4` | het filmpje, 25 s, 1920×1080, zonder geluid |
| `rekensterren-logo.mp4` | alleen het logo (de eerste 8 s) |
...
node promo/render.js logo 0 8      # -> rekensterren-logo.mp4
```
